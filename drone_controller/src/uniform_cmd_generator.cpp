...
int main(int argc, char** argv)
{
    ...
    // drone
    drone_pos.position.x = -2;
    drone_pos.position.y = 1;
    drone_pos.position.z = 1.7;
    // drone0
    drone0_pos.position.x = -2;
    drone0_pos.position.y = -1;
    drone0_pos.position.z = 1.7;
    // drone1
    drone1_pos.position.x = 1;
    drone1_pos.position.y = 1;
    drone1_pos.position.z = 1.7;
    // drone2
    drone2_pos.position.x = 1;
    drone2_pos.position.y = -1;
    drone2_pos.position.z = 1.7;
    // drone3
    drone3_pos.position.x = 4;
    drone3_pos.position.y = 1;
    drone3_pos.position.z = 1.7;
    // drone4
    drone4_pos.position.x = 4;
    drone4_pos.position.y = -1;
